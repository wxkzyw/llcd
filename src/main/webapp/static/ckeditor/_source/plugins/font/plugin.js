 ...
 * @type String
 * @example
 * // If the default jeesite font is Arial, we may making it more explicit to the end user.
 ...
 * @type String
 * @example
 * // If the default jeesite font size is 12px, we may making it more explicit to the end user.
