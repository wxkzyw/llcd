...
<div class="index-wrap">
            ...
            <div class="collapse navbar-collapse" id="nav-menu">
                <ul class="nav navbar-nav text-center nav-list navbar-right">
                    ...
                    <li class="dropdown" id="language">
                        <a href="${pageContext.request.contextPath}/f/cnSimpleManualList" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                            简体<span class="caret triangle"></span>
                        </a>
                        <ul class="dropdown-menu text-center language-list">
                            <li class="text-center"><a href="${pageContext.request.contextPath}/f/cnComplexManualList">繁体</a></li>
                            <li class="text-center"><a href="${pageContext.request.contextPath}/f/cnSimpleManualList">简体</a></li>
    ...
    <section class="banner">
        <img src="${ctxStatic}/images/aboutcnsimple.png" alt="资料下载" class="img-responsive">
    </section>
        ...
        <div class="container-fluid">
            <div class="title-bread">
                <p>
                    ...
                    <a href="${pageContext.request.contextPath}/f/cnSimpleDirectoryList">资料下载</a>
                </p>
            </div>
            <div class="main-content">
                <ul id="downloadTab" class="list-unstyled list-inline switch-tab">
                    <li>
                        <a href="${pageContext.request.contextPath}/f/cnSimpleDirectoryList">
                            产品目录
                        </a>
                    </li>
                    <li class="active">
                        <a href="${pageContext.request.contextPath}/f/cnSimpleManualList">
                            保养手册
                        </a>
                    </li>
                </ul>
                            ...
                            <c:forEach items="${directories}" var="bean">
                                <div class="col-md-2 col-sm-4 col-xs-12">
                                    <div class="pro-case-wrap">
                                        <a href="${pageContext.request.contextPath}/f/downloadProductsManual/cn-simple/${bean.fileName}">
