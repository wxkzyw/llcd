...
<div class="index-wrap">
            ...
            <div class="collapse navbar-collapse" id="nav-menu">
                <ul class="nav navbar-nav text-center nav-list navbar-right">
                    ...
                    <li class="dropdown" id="language">
                        <a href="${pageContext.request.contextPath}/f/cnSimpleNewsDetails/${article.id}" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                            简体<span class="caret triangle"></span>
                        </a>
                        <ul class="dropdown-menu text-center language-list">
                            <li class="text-center"><a href="${pageContext.request.contextPath}/f/cnComplexNewsDetails/${complexArticleID}">繁体</a></li>
                            <li class="text-center"><a href="${pageContext.request.contextPath}/f/cnSimpleNewsDetails/${article.id}">简体</a></li>
    ...
    <section class="banner">
        <img src="${ctxStatic}/images/aboutcnsimple.png" alt="新闻详情" class="img-responsive">
    </section>
        ...
        <div class="container-fluid">
            <div class="title-bread">
                <p>
                    ...
                    <a href="${pageContext.request.contextPath}/f/cnSimpleNewsDetails/${article.id}">新闻详情</a>
                </p>
            </div>
            <div class="content">
                <div class="news-details">
                    <div class="news-title">
                        <h2>${article.title}</h2>
                        <p> 发表时间：<span><fmt:formatDate value="${article.updateDate}"/></span></p>
                    </div>
