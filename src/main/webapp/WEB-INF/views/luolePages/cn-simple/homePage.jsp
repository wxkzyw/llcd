        ...
        <div class="swiper-wrapper">
            <c:forEach items="${indexImgs}" var="bean" varStatus="status">
                <div class="swiper-slide banner-item">
                    <img src="${pageContext.request.contextPath}/userfiles/1/images/homePage-cn-simple/${bean.imgName}${bean.imgSuffix}" alt="banner" class="img-responsive">
                </div>
            </c:forEach>
        ...
        <div class="container-fluid">
            ...
            <div class="row about-content">
                <div class="col-md-5 about-video">
                    <video id="aboutVideo" class="video-js vjs-default-skin" loop autoplay controls="true" poster="${ctxStatic}/images/about-cover.png" preload="auto" webkit-playsinline="true" playsinline="true" x-webkit-airplay="allow"  x5-video-player-type="h5" x5-video-player-fullscreen="true" x5-video-orientation="portraint">
            ...
            <div class="content">
                ...
                <div class="row news-item">
                    <div class="col-lg-3 col-md-3 col-xs-12 col-sm-12 news-cover">
                        <a href="${pageContext.request.contextPath}/f/cnSimpleNewsDetails/${bean.id}"><img src="${pageContext.request.contextPath}/userfiles/1/images/news/${bean.description}" alt=""></a>
                    </div>
