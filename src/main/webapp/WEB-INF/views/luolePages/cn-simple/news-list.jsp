                ...
                <c:forEach items="${newsList}" var="news">
                    <div class="row news-item">
                        <div class="col-lg-3 col-md-3 col-xs-12 col-sm-12 news-cover">
                            <a href="${pageContext.request.contextPath}/f/cnSimpleNewsDetails/${news.id}"><img src="${pageContext.request.contextPath}/userfiles/1/images/news/${news.description}" alt=""></a>
                        </div>
