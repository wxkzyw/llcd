...
<div class="index-wrap">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="nav-menu">
                <ul class="nav navbar-nav text-center nav-list navbar-right">
                    ...
                    <li class="active"><a href="${pageContext.request.contextPath}/f/cnSimpleAbout">关于村田</a></li>
    ...
    <section class="banner">
        <img src="${ctxStatic}/images/aboutcnsimple.png" alt="关于村田" class="img-responsive">
    </section>
        ...
        <div class="container-fluid">
            <div class="title-bread">
                <p>
                    ...
                    <a href="${pageContext.request.contextPath}/f/cnSimpleAbout">关于村田</a>
                </p>
            </div>
