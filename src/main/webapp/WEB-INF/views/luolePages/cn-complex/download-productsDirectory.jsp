                ...
                <ul class="nav navbar-nav text-center nav-list navbar-right">
                    ...
                    <li class="dropdown" id="language">
                        ...
                        <ul class="dropdown-menu text-center language-list">
                            <li class="text-center"><a href="${pageContext.request.contextPath}/f/cnComplexDirectoryList">繁體</a></li>
                            <li class="text-center"><a href="${pageContext.request.contextPath}/f/cnSimpleDirectoryList">簡體</a></li>
                            ...
                            <c:forEach items="${directories}" var="bean">
                                <div class="col-md-2 col-sm-4 col-xs-12">
                                    <div class="pro-case-wrap">
                                        <a href="${pageContext.request.contextPath}/f/downloadProductsDirectory/cn-complex/${bean.fileName}">
