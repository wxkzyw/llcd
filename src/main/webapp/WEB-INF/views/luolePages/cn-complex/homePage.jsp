        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="nav-menu">
                <ul class="nav navbar-nav text-center nav-list navbar-right">
                    <li class="active"><a href="${pageContext.request.contextPath}/f/cnComplexIndex">首頁</a></li>
                    ...
                    <li class="dropdown" id="language">
                        <a href="${pageContext.request.contextPath}/f/cnComplexIndex" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                            繁體<span class="caret triangle"></span>
                        </a>
                        <ul class="dropdown-menu text-center language-list">
                            <li class="text-center"><a href="${pageContext.request.contextPath}/f/cnComplexIndex">繁體</a></li>
                            <li class="text-center"><a href="${pageContext.request.contextPath}/f/cnSimpleIndex">簡體</a></li>
        ...
        <div class="container-fluid">
            ...
            <div class="row about-content">
                ...
                <div class="col-md-7 about-describe">
                    ...
                    <a href="${pageContext.request.contextPath}/f/cnComplexAbout" class="btn btn-default">瞭解更多</a>
                </div>
            </div>
        </div>
    </section>
                            ...
                            <div class="col-md-6 col-xs-12 col-sm-12 products-directory">
                                ...
                                <ul class="list-unstyled">
                                    <c:forEach items="${TSUNTIENproducts}" var="product">
                                        <li><a href="${pageContext.request.contextPath}/f/cnComplexProductDetails/${product.id}">${product.title}</a></li>
                                    </c:forEach>
                                </ul>
                                <a href="${pageContext.request.contextPath}/f/cnComplexProductList" class="btn btn-default">瞭解更多</a>
                            </div>
                            <div class="col-md-6 col-xs-12 col-sm-12 data-download">
                                <!--点击下载跳转到下载页面-->
                                <h3>資料下載</h3>
                                <p>產品目錄、保養手册</p>
                                <a href="${pageContext.request.contextPath}/f/cnSimpleDirectoryList" class="btn btn-default">點擊下載</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <c:forEach items="${news}" var="bean">
                    <div class="row news-item">
                        ...
                        <div class="col-lg-9 col-md-9 col-xs-12 col-sm-12 news-body">
                            ...
                            <a href="${pageContext.request.contextPath}/f/cnComplexNewsDetails/${bean.id}"><h4>${bean.title}</h4></a>
                            <a href="${pageContext.request.contextPath}/f/cnComplexNewsDetails/${bean.id}" class="news-content-wrap">
