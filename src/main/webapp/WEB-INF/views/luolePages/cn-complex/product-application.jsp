...
<div class="index-wrap">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="nav-menu">
                <ul class="nav navbar-nav text-center nav-list navbar-right">
                    ...
                    <li class="active"><a href="${pageContext.request.contextPath}/f/cnComplexProductApplicaiton">產品應用</a></li>
                    ...
                    <li class="dropdown" id="language">
                        <a href="${pageContext.request.contextPath}/f/cnComplexProductApplicaiton" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                            繁體<span class="caret triangle"></span>
                        </a>
                        <ul class="dropdown-menu text-center language-list">
                            <li class="text-center"><a href="${pageContext.request.contextPath}/f/cnComplexProductApplicaiton">繁體</a></li>
                            <li class="text-center"><a href="${pageContext.request.contextPath}/f/cnSimpleProductApplicaiton">簡體</a></li>
    ...
    <section class="banner">
        <img src="${ctxStatic}/images/aboutcncomplex.png" alt="產品應用" class="img-responsive">
    </section>
        ...
        <div class="container-fluid">
            <div class="title-bread">
                <p>
                    ...
                    <a href="${pageContext.request.contextPath}/f/cnComplexProductApplicaiton">產品應用</a>
                </p>
            </div>
                                                ...
                                                <div class="col-md-3 col-sm-4 col-xs-12">
                                                    <div class="pro-case-wrap">
                                                        <video class="video-js vjs-default-skin" controls poster="${ctxStatic}/images/products-cover.png" preload="auto" webkit-playsinline="true" playsinline="true" x-webkit-airplay="allow"  x5-video-player-type="h5" x5-video-player-fullscreen="true" x5-video-orientation="portraint">
                                                            <source src="${pageContext.request.contextPath}/userfiles/1/files/productApplication/cn-complex/${bean.catagoryName}/video/${video.fileName}${video.fileSuffix}" type="video/mp4">
                                                        </video>
                                                        <p>${video.fileName}</p>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <c:forEach items="${bean.imgs}" var="img">
                                                <div class="col-md-3 col-sm-4 col-xs-6">
                                                    <div class="pro-case-wrap">
                                                        <img src="${pageContext.request.contextPath}/userfiles/1/files/productApplication/cn-complex/${bean.catagoryName}/images/${img.imgName}${img.imgSuffix}" alt="${img.imgName}" class="img-responsive">
                                                        <p>${img.imgName}</p>
                                                    </div>
                                                </div>
                                            </c:forEach>
