...
<div class="index-wrap">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="nav-menu">
                <ul class="nav navbar-nav text-center nav-list navbar-right">
                    ...
                    <li class="active"><a href="${pageContext.request.contextPath}/f/cnComplexNewsList">新聞中心</a></li>
                    ...
                    <li class="dropdown" id="language">
                        <a href="${pageContext.request.contextPath}/f/cnComplexNewsList" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                            繁體<span class="caret triangle"></span>
                        </a>
                        <ul class="dropdown-menu text-center language-list">
                            <li class="text-center"><a href="${pageContext.request.contextPath}/f/cnComplexNewsList">繁體</a></li>
                            <li class="text-center"><a href="${pageContext.request.contextPath}/f/cnSimpleNewsList">簡體</a></li>
    ...
    <section class="banner">
        <img src="${ctxStatic}/images/aboutcncomplex.png" alt="新聞中心" class="img-responsive">
    </section>
        ...
        <div class="container-fluid">
            <div class="title-bread">
                <p>
                    ...
                    <a href="${pageContext.request.contextPath}/f/cnComplexNewsList">新聞中心</a>
                </p>
            </div>
            <div class="content">
                ...
                <c:forEach items="${newsList}" var="news">
                    <div class="row news-item">
                        <div class="col-lg-3 col-md-3 col-xs-12 col-sm-12 news-cover">
                            <a href="${pageContext.request.contextPath}/f/cnComplexNewsDetails/${news.id}"><img src="${pageContext.request.contextPath}/userfiles/1/images/news/${news.description}" alt=""></a>
                        </div>
                        <div class="col-lg-9 col-md-9 col-xs-12 col-sm-12 news-body">
                            ...
                            <a href="${pageContext.request.contextPath}/f/cnComplexNewsDetails/${news.id}"><h4>${news.title}</h4></a>
                            <a href="${pageContext.request.contextPath}/f/cnComplexNewsDetails/${news.id}" class="news-content-wrap">
...
<script type="text/javascript">
    ...
    function goto(currentPage) {
        window.location.href="${pageContext.request.contextPath}/f/cnComplexNewsList?currentPageStr="+currentPage;
    }
</script>
</body>
</html>