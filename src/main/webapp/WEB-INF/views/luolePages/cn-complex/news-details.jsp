...
<div class="index-wrap">
            ...
            <div class="collapse navbar-collapse" id="nav-menu">
                <ul class="nav navbar-nav text-center nav-list navbar-right">
                    ...
                    <li class="dropdown" id="language">
                        <a href="${pageContext.request.contextPath}/f/cnComplexNewsDetails/${article.id}" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
    ...
    <section class="banner">
        <img src="${ctxStatic}/images/aboutcncomplex.png" alt="新聞詳情" class="img-responsive">
    </section>
        ...
        <div class="container-fluid">
            <div class="title-bread">
                <p>
                    ...
                    <a href="${pageContext.request.contextPath}/f/cnComplexNewsDetails/${article.id}">新聞詳情</a>
                </p>
            </div>
            <div class="content">
                <div class="news-details">
                    <div class="news-title">
                        <h2>${article.title}</h2>
                        <p> 發表時間：<span><fmt:formatDate value="${article.updateDate}"/></span></p>
                    </div>
