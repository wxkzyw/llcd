...
<div class="index-wrap">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="nav-menu">
                <ul class="nav navbar-nav text-center nav-list navbar-right">
                    ...
                    <li class="active"><a href="${pageContext.request.contextPath}/f/complexcontact">聯繫我們</a></li>
                    <li class="dropdown">
                    ...
                    <li class="dropdown" id="language">
                        <a href="${pageContext.request.contextPath}/f/complexcontact" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                            繁體<span class="caret triangle"></span>
                        </a>
                        <ul class="dropdown-menu text-center language-list">
                            <li class="text-center"><a href="${pageContext.request.contextPath}/f/complexcontact">繁體</a></li>
                            <li class="text-center"><a href="${pageContext.request.contextPath}/f/contact">簡體</a></li>
                            <li class="text-center"><a href="${pageContext.request.contextPath}/f/englishcontact">英文</a></li>
                        </ul>
                    </li>
                </ul>
    ...
    <section class="banner">
        <img src="${ctxStatic}/images/aboutcncomplex.png" alt="聯繫我們" class="img-responsive">
    </section>
        ...
        <div class="container-fluid">
            <div class="title-bread">
                <p>
                    ...
                    <a href="${pageContext.request.contextPath}/f/complexcontact">聯繫我們</a>
                </p>
            </div>
