...
<div class="index-wrap">
            ...
            <div class="collapse navbar-collapse" id="nav-menu">
                <ul class="nav navbar-nav text-center nav-list navbar-right">
                    ...
                    <li class="dropdown" id="language">
                        <a href="${pageContext.request.contextPath}/f/englishNewsList" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                            English<span class="caret triangle"></span>
                        </a>
                        <ul class="dropdown-menu text-center language-list">
                            <li class="text-center"><a href="${pageContext.request.contextPath}/f/cnComplexNewsList">Traditional</a></li>
                            <li class="text-center"><a href="${pageContext.request.contextPath}/f/cnSimpleNewsList">Simplified</a></li>
                            <li class="text-center"><a href="${pageContext.request.contextPath}/f/englishNewsList">English</a></li>
                        </ul>
                    </li>
                </ul>
    ...
    <section class="banner">
        <img src="${ctxStatic}/images/aboutenglish.png" alt="News" class="img-responsive">
    </section>
                ...
                <c:forEach items="${newsList}" var="news">
                    <div class="row news-item">
                        ...
                        <div class="col-lg-9 col-md-9 col-xs-12 col-sm-12 news-body">
                            ...
                            <a href="${pageContext.request.contextPath}/f/englishNewsDetails/${news.id}"><h4>${news.title}</h4></a>
                            <a href="${pageContext.request.contextPath}/f/englishNewsDetails/${news.id}" class="news-content-wrap">
...
<script type="text/javascript">
    ...
    function goto(currentPage) {
        window.location.href="${pageContext.request.contextPath}/f/englishNewsList?currentPageStr="+currentPage;
    }
</script>
</body>
</html>