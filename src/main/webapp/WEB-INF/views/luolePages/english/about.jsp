...
<div class="index-wrap">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="nav-menu">
                <ul class="nav navbar-nav text-center nav-list navbar-right">
                    ...
                    <li class="active"><a href="${pageContext.request.contextPath}/f/englishAbout">About</a></li>
                    ...
                    <li class="dropdown" id="language">
                        <a href="${pageContext.request.contextPath}/f/englishAbout" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                            English<span class="caret triangle"></span>
                        </a>
                        <ul class="dropdown-menu text-center language-list">
                            <li class="text-center"><a href="${pageContext.request.contextPath}/f/cnComplexAbout">Traditional</a></li>
                            <li class="text-center"><a href="${pageContext.request.contextPath}/f/cnSimpleAbout">Simplified</a></li>
                            <li class="text-center"><a href="${pageContext.request.contextPath}/f/englishAbout">English</a></li>
                        </ul>
                    </li>
                </ul>
    ...
    <section class="banner">
        <img src="${ctxStatic}/images/aboutenglish.png" alt="about" class="img-responsive">
    </section>

    <!--about-->
    <section class="about-main content-wrap">
        <div class="container-fluid">
            <div class="title-bread">
                <p>
                    <a href="${pageContext.request.contextPath}/f/englishIndex">Home</a> >
                    <a href="${pageContext.request.contextPath}/f/englishAbout">About</a>
                </p>
            </div>
