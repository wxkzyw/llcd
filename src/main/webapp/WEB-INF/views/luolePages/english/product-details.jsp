                                ...
                                <c:when test="${introduction.imgName!=null&&introduction.articleData.content!=null}">
                                    <div class="col-md-4 col-sm-12 col-xs-12 products-details-cover">
                                        <c:if test="${newSeriesName==null}">
                                            <img src="http://www.tsuntien.com/userfiles/1/files/productSeries/english/${seriesName}/images/productIntroduce/${introduction.description}" alt="${introduction.imgName}" class="img-responsive">
                                        </c:if>
                                        <c:if test="${newSeriesName!=null}">
                                            <img src="http://www.tsuntien.com/userfiles/1/files/productSeries/english/${newSeriesName}/images/productIntroduce/${introduction.description}" alt="${introduction.imgName}" class="img-responsive">
                                        </c:if>
                                    </div>
                                    ...
                                    <c:choose>
                                        ...
                                        <c:when test="${bean.imgName=='pro-pt-1'}">
                                            ...
                                            <div class="col-xs-12 parameter-item">
                                                ...
                                                <c:if test="${newSeriesName==null}">
                                                    <img src="http://www.tsuntien.com/userfiles/1/files/productSeries/english/${seriesName}/images/productParameter/${bean.imgName}${bean.imgSuffix}" alt="订购说明" class="img-responsive">
                                                </c:if>
                                                <c:if test="${newSeriesName!=null}">
                                                    <img src="http://www.tsuntien.com/userfiles/1/files/productSeries/english/${newSeriesName}/images/productParameter/${bean.imgName}${bean.imgSuffix}" alt="订购说明" class="img-responsive">
                                                </c:if>
                                            </div>
                                        </c:when>
                                        ...
                                        <c:when test="${bean.imgName=='pro-pt-3'}">
                                            ...
                                            <div class="col-xs-12 parameter-item">
                                                ...
                                                <c:if test="${newSeriesName==null}">
                                                    <img src="http://www.tsuntien.com/userfiles/1/files/productSeries/english/${seriesName}/images/productParameter/${bean.imgName}${bean.imgSuffix}" alt="安装方式选项" class="img-responsive">
                                                </c:if>
                                                <c:if test="${newSeriesName!=null}">
                                                    <img src="http://www.tsuntien.com/userfiles/1/files/productSeries/english/${newSeriesName}/images/productParameter/${bean.imgName}${bean.imgSuffix}" alt="安装方式选项" class="img-responsive">
                                                </c:if>
                                            </div>
                                            d                                </c:when>
                                        ...
                                        <c:when test="${bean.imgName=='pro-pt-4'}">
                                            ...
                                            <div class="col-xs-12 parameter-item">
                                                ...
                                                <c:if test="${newSeriesName==null}">
                                                    <img src="http://www.tsuntien.com/userfiles/1/files/productSeries/english/${seriesName}/images/productParameter/${bean.imgName}${bean.imgSuffix}" alt="${seriesName}性能表" class="img-responsive">
                                                </c:if>
                                                <c:if test="${newSeriesName!=null}">
                                                    <img src="http://www.tsuntien.com/userfiles/1/files/productSeries/english/${newSeriesName}/images/productParameter/${bean.imgName}${bean.imgSuffix}" alt="${seriesName}性能表" class="img-responsive">
                                                </c:if>
                                            </div>
                                        </c:when>
                                        ...
                                        <c:when test="${bean.imgName=='pro-pt-5'}">
                                            <div class="col-xs-12 parameter-item">
                                                ...
                                                <c:if test="${newSeriesName==null}">
                                                    <img src="http://www.tsuntien.com/userfiles/1/files/productSeries/english/${seriesName}/images/productParameter/${bean.imgName}${bean.imgSuffix}" alt="${seriesName}尺寸图" class="img-responsive">
                                                </c:if>
                                                <c:if test="${newSeriesName!=null}">
                                                    <img src="http://www.tsuntien.com/userfiles/1/files/productSeries/english/${newSeriesName}/images/productParameter/${bean.imgName}${bean.imgSuffix}" alt="${seriesName}尺寸图" class="img-responsive">
                                                </c:if>
                                            </div>
                                        </c:when>
                                    ...
                                    <div class="col-md-3 col-sm-4 col-xs-12">
                                        <div class="pro-case-wrap">
                                            <video class="video-js vjs-default-skin" controls poster="${ctxStatic}/images/products-cover.png" preload="auto" webkit-playsinline="true" playsinline="true" x-webkit-airplay="allow"  x5-video-player-type="h5" x5-video-player-fullscreen="true" x5-video-orientation="portraint">
                                                <c:if test="${newSeriesName==null}">
                                                    <source src="http://www.tsuntien.com/userfiles/1/files/productSeries/english/${seriesName}/video/${bean.fileName}${bean.fileSuffix}" type="video/mp4">
                                                </c:if>

                                                <c:if test="${newSeriesName!=null}">
                                                    <source src="http://www.tsuntien.com/userfiles/1/files/productSeries/english/${newSeriesName}/video/${bean.fileName}${bean.fileSuffix}" type="video/mp4">
                                                </c:if>
                                            </video>
                                            <p>${bean.fileName}</p>
                                        </div>
                            ...
                            <div class="row">
                                <c:forEach items="${casesImgs}" var="bean">
                                    <div class="col-md-3 col-sm-4 col-xs-12">
                                        <div class="pro-case-wrap">
                                            <c:if test="${newSeriesName==null}">
                                                <img src="http://www.tsuntien.com/userfiles/1/files/productSeries/english/${seriesName}/images/productCase/${bean.imgName}${bean.imgSuffix}" alt="产品案例" class="img-responsive">
                                            </c:if>
                                            <c:if test="${newSeriesName!=null}">
                                                <img src="http://www.tsuntien.com/userfiles/1/files/productSeries/english/${newSeriesName}/images/productCase/${bean.imgName}${bean.imgSuffix}" alt="产品案例" class="img-responsive">
                                            </c:if>
                                            <p>${bean.imgName}</p>
                                        </div>
                                    </div>
