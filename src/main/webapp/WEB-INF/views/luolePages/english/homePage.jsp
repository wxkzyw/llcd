        ...
        <div class="swiper-wrapper">
            <c:forEach items="${indexImgs}" var="bean" varStatus="status">
                <div class="swiper-slide banner-item">
                    <img src="http://www.tsuntien.com/userfiles/1/images/homePage-english/${bean.imgName}${bean.imgSuffix}" alt="banner" class="img-responsive">
                </div>
            </c:forEach>
                ...
                <c:forEach items="${news}" var="bean">
                    <div class="row news-item">
                        <div class="col-lg-3 col-md-3 col-xs-12 col-sm-12 news-cover">
                            <a href="${pageContext.request.contextPath}/f/englishNewsDetails/${bean.id}"><img src="http://www.tsuntien.com/userfiles/1/images/news/${bean.description}" alt=""></a>
                        </div>
