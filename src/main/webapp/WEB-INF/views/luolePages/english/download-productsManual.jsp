...
<div class="index-wrap">
            ...
            <div class="collapse navbar-collapse" id="nav-menu">
                <ul class="nav navbar-nav text-center nav-list navbar-right">
                    ...
                    <li class="dropdown active">
                        <a href="${pageContext.request.contextPath}/f/englishManualList" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                            Download
                        </a>
                    ...
                    <li class="dropdown" id="language">
                        ...
                        <ul class="dropdown-menu text-center language-list">
                            <li class="text-center"><a href="${pageContext.request.contextPath}/f/cnComplexManualList">Traditional</a></li>
                            <li class="text-center"><a href="${pageContext.request.contextPath}/f/cnSimpleManualList">Simplified</a></li>
                            <li class="text-center"><a href="${pageContext.request.contextPath}/f/englishManualList">English</a></li>
                        </ul>
                    </li>
                </ul>
    ...
    <section class="banner">
        <img src="${ctxStatic}/images/aboutenglish.png" alt="Download" class="img-responsive">
    </section>
        ...
        <div class="container-fluid">
            <div class="title-bread">
                <p>
                    ...
                    <a href="${pageContext.request.contextPath}/f/englishDirectoryList">Download</a>
                </p>
            </div>
            <div class="main-content">
                <ul id="downloadTab" class="list-unstyled list-inline switch-tab">
                    <li>
                        <a href="${pageContext.request.contextPath}/f/englishDirectoryList">
                            Directory
                        </a>
                    </li>
                    <li class="active">
                        <a href="${pageContext.request.contextPath}/f/englishManualList">
                            Manual
                        </a>
                    </li>
                </ul>
                <div id="downloadContent" class="tab-content">
                    <!--产品目录-->
                    <div class="tab-pane active" id="productsDirectory">
                        <div class="row">
                            <c:forEach items="${directories}" var="bean">
                                <div class="col-md-2 col-sm-4 col-xs-12">
                                    <div class="pro-case-wrap">
                                        <a href="${pageContext.request.contextPath}/f/downloadProductsDirectory/english/${bean.fileName}">
