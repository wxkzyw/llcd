...
<head>
	...
	<script type="text/javascript">
		...
		function fileUpload() {
            $.ajaxFileUpload({
                fileElementId: 'videoUpload',    //需要上传的文件域的ID，即<input type="file">的ID。
	...
	<form:form id="inputForm" modelAttribute="article" action="${ctx}/cms/article/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<span class="help-inline">输入版本:简体 繁体 英文</span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label">关联图片:</label>
			<div class="controls">
				<form:textarea path="description" htmlEscape="false" rows="4" maxlength="200" class="input-xxlarge"/>
				<span class="help-inline">填写文件管理-images文件夹中的对应的图片名称</span>
			</div>
		</div>
		<%--<div class="control-group">
			<label class="control-label">视频上传:</label>
			<div class="controls">
				<form:input path="articleData.videoUrl" htmlEscape="false" maxlength="200" class="input-xlarge"/>
				<input type="file" id="videoUpload" name="videoUpload">
				<button type="button" onclick="javascript:fileUpload()">上传</button>
			</div>
		</div>--%>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<span class="help-inline">选择相应产品关联</span>
				<script type="text/javascript">
					var articleSelect = [];
