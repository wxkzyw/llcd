...
//	{
//		return find("from Category where delFlag=:p1 and (module='' or module=:p2) order by jeesite.id, sort",
//				new Parameter(Category.DEL_FLAG_NORMAL, module));
//	}
	
	public List<Category> findByParentId(String parentId, String isMenu);
//	{
//		return find("from Category where delFlag=:p1 and parent.id=:p2 and inMenu=:p3 order by jeesite.id, sort",
...
//	{
//		return find("from Category where delFlag=:p1 and parent.id=:p2 and jeesite.id=:p3 order by jeesite.id, sort",
